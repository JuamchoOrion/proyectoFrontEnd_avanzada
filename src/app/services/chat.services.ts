...
export class ChatService {
  ...
  private apiUrl =
    'https://proyectofinal-programacion-avanzada-production-5ceb.up.railway.app/chat';
  private wsUrl = 'ws://proyectofinal-programacion-avanzada-production-5ceb.up.railway.app/ws-chat'; // backend
