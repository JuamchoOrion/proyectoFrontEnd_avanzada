...
export class AccommodationService {
  private apiUrl = 'https://proyectofinal-programacion-avanzada-production.up.railway.app/api/accommodations';
  ...
  getHostProfile(
    ...
    return this.http
      ...
      }>(`https://proyectofinal-programacion-avanzada-production.up.railway.app/users/${id}`)
